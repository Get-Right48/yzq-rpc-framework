...
public class CuratorClient {
    ...
    public CuratorClient(String connect,String namespace,int sessionTimeout, int connectTimeout){
    ...
    public CuratorClient(String connect){
        this(connect, Constant.ZK_NAMESPACE,Constant.ZK_SESSION_TIMEOUT,Constant.ZK_CONNECTION_TIMEOUT);
    }
